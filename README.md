...
- 🔧 **Enhanced CLI** with 44+ commands, performance monitoring, and health checks
...
- 📊 **Performance Analytics**: Built-in command execution tracking and optimization
...
The Lorm CLI provides **enterprise-grade tooling** with comprehensive type safety, performance monitoring, and health diagnostics.
...
- `npx @lorm/cli db:drop` — Drop all tables (development only, with safety checks)
